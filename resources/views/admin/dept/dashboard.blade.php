          ...
          <div class="page-heading">
            ...
            <div class="heading-actions">
              <a class="btn btn-outline-secondary btn-sm" href="tables.html">
                ...
                <a class="btn btn-primary btn-sm" href="{{ route('dept.add') }}">
            ...
            <div class="panel-header">
              <div>
                <h2 class="h5 mb-1 section-title">
                  ...
                  </i><span>Departement List</span></h2>
              ...
              <div class="d-flex flex-wrap gap-2">
                <a class="btn btn-primary btn-sm" href="{{ route('dept.add') }}">
                  <i class="bi bi-person-plus" aria-hidden="true"></i> Add Departement</a>
              </div>
            </div>
